function [data, params] = lab5_simulate_b4Test
    

    % quadrotor tracking an object
    % simulate movement of obstacle to test performance of tracking
  ...
  %  - planner
    ...
    for i = 1:round(tf/params.dt)
        ...
        obst{1}.p = [cos(0.5*t); sin(0.5*t); -0.5];
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
